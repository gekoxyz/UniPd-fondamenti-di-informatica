public class CheckingAccount extends BankAccount {
    ...
    public boolean equals(Object toCompare) {
        CheckingAccount otherAccount = (CheckingAccount) toCompare;
        return transactionCount == otherAccount.transactionCount && super.equals(toCompare);
    }

    @Override
    public String toString() {
        return "transactionCount: " + transactionCount + "\t" + super.toString();
    }
